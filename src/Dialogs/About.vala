...
namespace Meteo {
    public class Dialogs.About : Gtk.Dialog  {
        public About () {
            ...
            var name_label = new AboutLabel ("Pantheon-meteo " + Constants.VERSION);
            name_label.get_style_context ().add_class (Granite.STYLE_CLASS_H2_LABEL);

            var website = "https://github.com/Dirli/pantheon-meteo";
            ...
            var comments_label = new AboutLabel (_("A weather forecast application that uses the OpenWeatherMap API designed for Pantheon DE"));

            var license_url = "http://www.gnu.org/licenses/old-licenses/gpl-2.0.html";
